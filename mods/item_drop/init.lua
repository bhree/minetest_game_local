...
minetest.register_globalstep(function(dtime)
	...
	for _,player in ipairs(minetest.get_connected_players()) do
		...
		if player:get_hp() > 0 and player:get_wielded_item():get_name() == "item_drop:moon_magnet" then
...
minetest.register_craftitem("item_drop:moon_magnet", {
		description = "Harness Moon Gravity",
		image = "moon_magnet.png",
	})

minetest.register_craft({
	output = "item_drop:moon_magnet",
	recipe = {
		{"space:moon_stone", "space:moon_stone", "space:moon_stone"},
		{"space:moon_stone", "nssb:bucket_mornen", "space:moon_stone"},
		{"space:moon_stone", "space:moon_stone", "space:moon_stone"},
	}
})
