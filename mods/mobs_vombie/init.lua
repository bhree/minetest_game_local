local version = "0.2.3x"

-- local S = mobs.intllib
local mm = mobsmonsters.multimobs
...
local modpath = minetest.get_modpath("mobs_vombie")

dofile (modpath .. "/flame.lua")

mobs:register_mob("mobs_vombie:vombie", {
	type = "monster",
	passive = false,
	...
	mesh = "animal_vombie_vombie.b3d",
	textures = {
		{"animal_vombie_vombie_mesh.png"},
	},
	blood_texture = "default_dirt.png",
	makes_footstep_sound = true,
	sounds = {
		random = "animal_vombie_random_1",
		damage = "animal_vombie_sun_damage",
		attack = "animal_vombie_hit"
	},
	view_range = 15,
	walk_velocity = 1,
	run_velocity = 3,
	jump = true,
	drops = {
		{name = "animalmaterials:bone", chance = 1, min = 1, max = 2},
		{name = "animalmaterials:meat_undead", chance = 1, min = 1, max = 1}
	},
	water_damage = 1,
	lava_damage = 5,
	light_damage = 2,
...
-- mobs:register_spawn("mobs_vombie:vombie", {"default:dirt_with_grass", "default:sand", "default:desert_sand"}, 7, 0, 70000/mm, 1, 2000, false)
mobs:spawn({
	name = "mobs_vombie:vombie",
	nodes = {"default:dirt_with_grass", "default:sand", "default:desert_sand"},
	min_light = 0,
	max_light = 7,
	chance = 65000/mm,
...
mobs:register_egg("mobs_vombie:vombie", "Mob Vombie", "animal_vombie_vombie_item.png", 1)

-- compatibility
mobs:alias_mob("mobs:vombie", "mobs_vombie:vombie")
