					...
					if piece then
						if pieceColor ~= color then
							...
							elseif piece == "queen" and queenThreats[dir] then
								threatDetected = true
							--elseif piece == "knight" and knightThreats[dir] then
							--	threatDetected = true
							else
								if step == 1 then
...
function realchess.move(pos, from_list, from_index, to_list, to_index, _, player)
	...
	if black_king_idx == nil or white_king_idx == nil then return 0 end
