...
minetest.register_craftitem("rangedweapons:spas12_uld", {
	...
	range = 0,
		description = "Franchi SPAS-12, ammo: 12 gauge shells",
...
minetest.register_globalstep(function(dtime, player)
	...
	for _, player in pairs(minetest.get_connected_players()) do
		...
		timer = 0
				minetest.sound_play("rangedweapons_shotgun_reload_a", {pos = player:get_pos()})
	...
	if timer >= 0.45 and
		...
		timer = 0
				minetest.sound_play("rangedweapons_shotgun_reload_b", {pos = player:get_pos()})
