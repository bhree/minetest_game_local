...
minetest.register_craftitem("rangedweapons:m200_uld", {
	...
	range = 0,
		description = "M200 Intervention, ammo: 308. Winchester",
...
minetest.register_globalstep(function(dtime, player)
	...
	for _, player in pairs(minetest.get_connected_players()) do
		...
		timer = 0
				minetest.sound_play("rangedweapons_reload_a", {pos = player:get_pos()})
	...
	if timer >= 1.75 and
		...
		timer = 0
				minetest.sound_play("rangedweapons_reload_b", {pos = player:get_pos()})
