...
minetest.register_node("cavestuff:pebble_1",{
    ...
    paramtype = "light",
	paramtype2 = "facedir",
    groups = {cracky=3, stone=1, falling_node = 1, oddly_breakable_by_hand=1},
    selection_box = cbox,
    collision_box = cbox,
...
minetest.register_node("cavestuff:pebble_2",{
    ...
    paramtype = "light",
	paramtype2 = "facedir",
    groups = {cracky=3, stone=1, not_in_creative_inventory=1, falling_node = 1, oddly_breakable_by_hand=1},
	selection_box = cbox,
	collision_box = cbox,
    sounds = default.node_sound_stone_defaults(),
})
