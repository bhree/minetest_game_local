...
if minetest.get_modpath("nssm") ~= nil then
	overwrite ("nssm:werewolf_leg",3)
	overwrite ("nssm:felucco_steak",3)
	overwrite ("nssm:roasted_felucco_steak",6)
	overwrite ("nssm:heron_leg",2)
	overwrite ("nssm:chichibios_heron_leg",4)
	overwrite ("nssm:crocodile_tail",3)
	overwrite ("nssm:roasted_crocodile_tail",6)
	overwrite ("nssm:roasted_werewolf_leg",6)
	overwrite ("nssm:duck_legs",1)
	overwrite ("nssm:roasted_duck_legs",3)
	overwrite ("nssm:ant_leg",-1)
	overwrite ("nssm:roasted_ant_leg",4)
	overwrite ("nssm:spider_leg",-1)
	overwrite ("nssm:roasted_spider_leg",4)
--overwrite ("nssm:brain","Brain",3)
--overwrite ("nssm:roasted_brain","Roasted Brain",8)
	overwrite ("nssm:tentacle",2)
	overwrite ("nssm:roasted_tentacle",5)
	overwrite ("nssm:worm_flesh",-2)
	overwrite ("nssm:roasted_worm_flesh",4)
	overwrite ("nssm:amphibian_heart",1)
	overwrite ("nssm:roasted_amphibian_heart",8)
	overwrite ("nssm:raw_scrausics_wing",1)
	overwrite ("nssm:spicy_scrausics_wing",6)
	overwrite ("nssm:phoenix_nuggets",20)
	overwrite ("nssm:phoenix_tear",20)
	overwrite ("nssm:frosted_amphibian_heart",-1)
	overwrite ("nssm:surimi",4)
	overwrite ("nssm:amphibian_ribs",2)
	overwrite ("nssm:roasted_amphibian_ribs",6)
	overwrite ("nssm:dolidrosaurus_fin",-2)
	overwrite ("nssm:roasted_dolidrosaurus_fin",4)
	overwrite ("nssm:larva_meat",-1)
	overwrite ("nssm:larva_juice",-3)
	overwrite ("nssm:larva_soup",10)
	overwrite ("nssm:mantis_meat",1)
	overwrite ("nssm:roasted_mantis_meat",4)
	overwrite ("nssm:spider_meat",-1)
	overwrite ("nssm:roasted_spider_meat",3)
	overwrite ("nssm:silk_gland",-1)
	overwrite ("nssm:roasted_silk_gland",3)
	overwrite ("nssm:super_silk_gland",-8)
	overwrite ("nssm:roasted_super_silk_gland",2)
end