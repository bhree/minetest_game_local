...
function hardtrees.conf()
  ...
  if not rock_interval then local rock_interval = 2880 end -- rock generation interval
  if not rock_chance then local rock_chance = 1000 end -- rock generation chance
  if not gen_sticks then local gen_sticks = true end -- generate sticks
  if not stick_distance then local stick_distance = 5 end -- stick generation distance
  if not stick_interval then local stick_interval = 2880 end -- stick generation interval
  if not stick_chance then local stick_chance = 1000 end -- stick generation chance
end
