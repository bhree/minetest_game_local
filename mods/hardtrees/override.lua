...
--default bush
hardtrees.override.leaf("default:bush_leaves", "default:sapling")

--default acacia bush
hardtrees.override.leaf("default:acacia_bush_leaves", "default:acacia_sapling")
...
if minetest.get_modpath("moretrees") then
  ...
  -- hardtrees.override.tree("moretrees:cedar_trunk")
  
  -- moretrees:poplar
  hardtrees.override.moretrees("poplar")
  
  -- moretree:jungle_leaves
