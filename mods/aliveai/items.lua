...
-- long list of banned items
			if minetest.registered_tools["thirsty:wooden_bowl"] then return self end
			if minetest.registered_tools["thirsty:steel_canteen"] then return self end
			if minetest.registered_tools["thirsty:bronze_canteen"] then return self end
			if minetest.registered_tools["aging:fountain_of_youth"] then return self end
			if minetest.registered_tools["aging:cancer_cure"] then return self end
			if minetest.registered_tools["default:dry_shrub"] then return self end
